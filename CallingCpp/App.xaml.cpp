...
using namespace CallingCpp;
using namespace CallingCpp::implementation;
...
void App::OnLaunched(LaunchActivatedEventArgs const& e)
{
    ...
    if (rootFrame == nullptr)
    {
        ...
        if (e.PrelaunchActivated() == false)
        {
            if (rootFrame.Content() == nullptr)
            {
                ...
                // parameter
                rootFrame.Navigate(xaml_typename<CallingCpp::MainPage>(), box_value(e.Arguments()));
            }
    ...
    else
    {
     ...
     // In a real app, you would initialize push notifications here or after user logs in.
     // Example:
