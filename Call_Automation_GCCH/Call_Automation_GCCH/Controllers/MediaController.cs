...
namespace Call_Automation_GCCH.Controllers
{
    ...
    public class MediaController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(ProblemDetails), 500)]
        [Tags("Hold UnHold APIs")]
        public async Task<IActionResult> UnholdAcsTargetAsync(string callConnectionId, string acsTarget, bool isPlaySource)
        {
            try
            {
                if (string.IsNullOrEmpty(callConnectionId))
        ...
        [ProducesResponseType(typeof(ProblemDetails), 500)]
        [Tags("Hold UnHold APIs")]
        public IActionResult UnholdAcsTarget(string callConnectionId, string acsTarget, bool isPlaySource)
        {
            try
            {
                if (string.IsNullOrEmpty(callConnectionId))
