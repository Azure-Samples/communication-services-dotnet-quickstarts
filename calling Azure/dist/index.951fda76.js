...
})({"4YqBd":[function(require,module,exports) {
"use strict";
 ...
 */ createLocalVideoStream = async ()=>{
    ...
    if (camera) return new LocalVideoStream(camera);
    else console.error(`No camera device found on the system`);
};
/**
...
},{"@azure/communication-calling":"e6SwF","@azure/communication-common":"l88Yi","@azure/logger":"7TN6Y"}]},["4YqBd","7Uf42"], "7Uf42", "parcelRequire688c")
