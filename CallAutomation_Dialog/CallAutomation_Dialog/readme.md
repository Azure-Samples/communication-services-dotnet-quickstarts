...
2. git clone https://github.com/ramneettung-msft/dialog-test-app.git.

### Locally running the Call Automation Dialog app
1. Go to CallAutomation_Dialog folder and open `CallAutomation_Dialog.sln` solution in Visual Studio.
