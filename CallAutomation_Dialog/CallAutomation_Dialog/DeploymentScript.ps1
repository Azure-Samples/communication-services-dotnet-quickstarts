...
#    - C:\inetpub\wwwroot\dialogsite directory (or it will be created)
#
# USAGE:
# ------
...
# 5. Extracts and deploys the app to IIS web root on the VM
...
$deployScript = @'
$webAppPath = "C:\inetpub\wwwroot\dialogsite"
